...
\begin{frame}{Ingeniería temprana (≈ 10.000 a.C. -- 500 a.C.)}
    \begin{itemize}
        \item \textbf{Revolución agrícola (≈ 10.000 a.C.):}
        \begin{itemize}
            \item Aparición de riego, almacenamiento y planificación del territorio
            \item Ingeniería como \textbf{gestión de recursos}
        \end{itemize}
        
        \item \textbf{Mesopotamia y Egipto (≈ 3500--1500 a.C.):}
        \begin{itemize}
...
\begin{frame}{Mundo clásico e ``ingeniería pública'' (≈ 500 a.C. -- 500 d.C.)}
    \begin{itemize}
        \item \textbf{Grecia:}
        \begin{itemize}
...
\begin{frame}{De técnica artesanal a ciencia y profesión (≈ 1500--1900)}
    \begin{itemize}
        ...
        \item \textbf{Revolución Industrial (≈ 1700--1900):}
        \begin{itemize}
...
\begin{frame}{Redes eléctricas: nace el ``sistema'' de potencia (≈ 1890--hoy)}
    \begin{itemize}
...
\begin{frame}{Comunicaciones: del telégrafo a la radio (≈ 1830--1930)}
    \begin{itemize}
